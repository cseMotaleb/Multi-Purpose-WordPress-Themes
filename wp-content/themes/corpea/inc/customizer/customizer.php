...
if (!class_exists('THMC_Framework')):
	...
	class THMC_Framework
	{
		...
		public function customizer_scripts()
		{
			...
			wp_enqueue_style( 'thmc-select2', get_template_directory_uri().'/inc/customizer/assets/select2/css/select2.min.css' );
			wp_enqueue_style( 'thmc-customizer', get_template_directory_uri().'/inc/customizer/assets/css/customizer.css' );

			// Load all js
			wp_enqueue_script( 'jquery-ui-datepicker' );
			wp_enqueue_script( 'wp-color-picker' );
			wp_enqueue_script( 'thmc-select2', get_template_directory_uri().'/inc/customizer/assets/select2/js/select2.min.js', array('jquery'), '1.0', true );
			wp_enqueue_script( 'thmc-rgba-colorpicker', get_template_directory_uri().'/inc/customizer/assets/js/thmc-rgba-colorpicker.js', array('jquery', 'wp-color-picker'), '1.0', true );
			wp_enqueue_script( 'thmc-customizer', get_template_directory_uri().'/inc/customizer/assets/js/customizer.js', array('jquery', 'jquery-ui-datepicker'), '1.0', true );
