...
class Widget_Themesmoon_about extends Widget_Base {
	public function get_name() {
		return 'thmoon-about';
	}

	public function get_title() {
		return __( 'Themesmmon About', 'coprea' );
	}
...
Plugin::instance()->widgets_manager->register_widget_type( new Widget_Themesmoon_about() );