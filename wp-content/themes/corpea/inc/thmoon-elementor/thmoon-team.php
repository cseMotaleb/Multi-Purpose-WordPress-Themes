...
class Widget_corpea_team extends Widget_Base {
	public function get_name() {
		return 'thmoon-team';
	}

	public function get_title() {
		return __( 'Themeum Team', 'corpea' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
		    'team_headline',
		    [
		        'label'     => __( 'Select the Elements', 'corpea' ),
		        'type'      => Controls_Manager::SELECT,
		        'default'   => 'h3',
		        'options'   => [
		                'h1'  	=> 'H1',
        ...
        $this->add_control(
           	'team_title',
            [
                'label' 		=> __( 'Name', 'corpea' ),
                'type' 			=> Controls_Manager::TEXT,
                'label_block' 	=> true,
                'placeholder' 	=> __( 'Enter Name', 'corpea' ),
                'default' 		=> __( 'Jon Deo', 'corpea' ),
            ]
        );
        ...
        $this->add_control(
           	'team_subtitle',
            [
                'label' 		=> __( 'Designation', 'corpea' ),
                'type' 			=> Controls_Manager::TEXT,
                'label_block' 	=> true,
                'placeholder' 	=> __( 'Enter Designation', 'corpea' ),
                'default' 		=> __( 'Developer', 'corpea' ),
            ]
        );
        $this->add_control(
            'team_desc',
            [
                'label' 		=> __( 'Description', 'corpea' ),
                'type' 			=> Controls_Manager::TEXTAREA,
                'label_block' 	=> true,
                'placeholder' 	=> __( 'Enter Description', 'corpea' ),
                'default' 		=> __( 'Write your description content of this section.', 'corpea' ),
            ]
        );         
		...
		$this->add_control(
			'team_social',
			[
				'label' => __( 'Show Social', 'corpea' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => '',
				'label_on' => __( 'Show', 'corpea' ),
				'label_off' => __( 'Hide', 'corpea' ),
				'return_value' => 'yes',
			]
		);
		$this->add_control(
		...
		$this->add_control(
			'team_google-plus',
			[
				'label' => __( 'Google Plus URL', 'corpea' ),
				'type' => Controls_Manager::URL,
				'placeholder' => __( 'http://your-link.com', 'corpea' ),
				'condition' => [
					'team_social' => 'yes',
		...
		$this->add_control(
			'stayle_1_color',
			[
				'label'		=> __( 'Basic Background Color', 'corpea' ),
				...
				'selectors' => [
					'{{WRAPPER}} .themesmoon-team-wrap-1 .themesmoon-team-wrap' => 'background-color: {{VALUE}};',
				],
				'condition' => [
					'team_layout' => '1',
				],
		...
		$this->add_control(
			'name_hover_color',
			[
				'label'		=> __( 'Name Hover Color', 'corpea' ),
				'type'		=> Controls_Manager::COLOR,
				'scheme'	=> [
				    'type'	=> Scheme_Color::get_type(),
				    'value' => Scheme_Color::COLOR_1,
		...
		$this->start_controls_section(
			...
			[
				'label' 	=> __( 'Designation Style', 'corpea' ),
				'tab' 		=> Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			'designation_color',
			[
				'label'		=> __( 'Designation Color', 'corpea' ),
				'type'		=> Controls_Manager::COLOR,
				'scheme'	=> [
				    'type'	=> Scheme_Color::get_type(),
				    'value' => Scheme_Color::COLOR_1,
		...
		$this->add_responsive_control(
            'designation_padding',
            [
                'label' 		=> __( 'Designation Padding', 'corpea' ),
                'type' 			=> Controls_Manager::DIMENSIONS,
                'size_units' 	=> [ 'px', 'em', '%' ],
                'selectors' 	=> [
		...
		$this->start_controls_section(
			...
			[
				'label' 	=> __( 'Description Style', 'corpea' ),
				'tab' 		=> Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			'description_color',
			[
				'label'		=> __( 'Description Color', 'corpea' ),
				'type'		=> Controls_Manager::COLOR,
				'scheme'	=> [
				    'type'	=> Scheme_Color::get_type(),
				    'value' => Scheme_Color::COLOR_1,
	...
	?>
		<div class="themesmoon-team-wrap-<?php echo $layout; ?>">
		    <div class="themesmoon-team-wrap">
		        <div class="item corpea_team">
		            <?php
		            	switch ( $layout ) {
			                case '2':
...
Plugin::instance()->widgets_manager->register_widget_type( new Widget_corpea_team() );