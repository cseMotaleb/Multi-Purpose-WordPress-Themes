...
class Widget_Feature_Box extends Widget_Base {
	...
	public function get_title() {
		return __( 'Themesmoon Service Box', 'corpea' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options' 		=> [
						'default' 		=> __( 'Default', 'corpea' ),
						'stacked' 		=> __( 'Stacked', 'corpea' ),
						'framed' 		=> __( 'Framed', 'corpea' ),
						'title_icon' 	=> __( 'Title With Icon', 'corpea' ),
						],
				'default' 		=> 'default',
		...
		$this->add_control(
			'shape',
			[
				'label' 		=> __( 'Shape', 'corpea' ),
				'type' 			=> Controls_Manager::SELECT,
				'options' 		=> [
							'circle' 	=> __( 'Circle', 'corpea' ),
							'square' 	=> __( 'Square', 'corpea' ),
							],
				'default' 		=> 'circle',
				'condition' 	=> [
							'view!' 	=> 'default',
		...
		$this->add_control(
			'title_text',
			[
				'label' 		=> __( 'Title & Description', 'corpea' ),
				'type' 			=> Controls_Manager::TEXT,
				'default' 		=> __( 'This is the heading', 'corpea' ),
				'placeholder' 	=> __( 'Your Title', 'corpea' ),
				'label_block' 	=> true,
			]
		);
		$this->add_control(
			...
			[
				...
				'default' 		=> __( 'Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'corpea' ),
				'placeholder' 	=> __( 'Your Description', 'corpea' ),
				'title'			=> __( 'Input icon text here', 'corpea' ),
				'rows' 			=> 10,
				'separator' 	=> 'none',
				'show_label' 	=> false,
			]
		...
		$this->add_control(
			'title_size',
			[
				'label' 	=> __( 'Title HTML Tag', 'corpea' ),
				'type' 		=> Controls_Manager::SELECT,
				'options'	=> [
							'h1' 	=> __( 'H1', 'corpea' ),
							'h2' 	=> __( 'H2', 'corpea' ),
		...
		$this->add_control(
			'secondary_color',
			[
				'label' 		=> __( 'Secondary Color', 'corpea' ),
				'type' 			=> Controls_Manager::COLOR,
				'condition' 	=> [
									'view!' => 'default',
								],
		...
		$this->add_control(
			...
			[
				'label' 		=> __( 'Vertical Alignment', 'corpea' ),
				'type' 			=> Controls_Manager::SELECT,
				'options' => [
					'top' 		=> __( 'Top', 'corpea' ),
					'middle' 	=> __( 'Middle', 'corpea' ),
					'bottom' 	=> __( 'Bottom', 'corpea' ),
				],
				'default' 		=> 'top',
		...
		$this->add_responsive_control(
			'description_margin',
			[
				'label' 		=> __( 'Description Margin', 'corpea' ),
				'type' 			=> Controls_Manager::DIMENSIONS,
				'size_units' 	=> [ 'px', 'em', '%' ],
				'selectors' 	=> [
		...
		$this->add_control(
			'total_hover_color',
			[
				'label' 		=> __( 'Total Hover Color', 'corpea' ),
				'type' 			=> Controls_Manager::COLOR,
				'default' 		=> '',
				'selectors' 	=> [
		...
		$this->add_control(
			'total_bg_color',
			[
				'label' 		=> __( 'Total BG Color', 'corpea' ),
				'type' 			=> Controls_Manager::COLOR,
				'default' 		=> '#ffffff',
				'selectors' 	=> [
		...
		$this->add_control(
			...
			[
				'label' 		=> __( 'Total BG Hover Color', 'corpea' ),
				'type' 			=> Controls_Manager::COLOR,
				'selectors' 	=> [
		...
		$this->add_control(
			...
			[
				'label' 		=> __( 'Border Hover Color', 'corpea' ),
				'type' 			=> Controls_Manager::COLOR,
				'selectors' 	=> [
