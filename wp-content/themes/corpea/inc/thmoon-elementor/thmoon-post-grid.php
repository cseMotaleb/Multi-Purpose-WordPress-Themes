...
class Themesmoon_Widget_Posts_Grid extends Widget_Base {

	public function get_name() {
		return 'thmoon-posts-grid';
	}

	public function get_title() {
		return __( 'Themesmoon Posts Grid', 'corpea' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .corpea-post .entry-summary' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' 	=> '{{WRAPPER}} .corpea-post .entry-summary',
			]
		);
		...
		<div class="row">
			<?php if ( $data->have_posts() ) : ?>
				...
				<div class="blog-post-item-col col-<?php echo $post_column; ?>">
				    <article class="corpea-post corpea-single-post corpea-index-post">
				        ...
				        <?php } ?>
				        <div class="corpea-blog-title clearfix">
				            ...
				            <div class="entry-blog">
				                <div class="entry-summary clearfix">
				                    <?php echo themesmoon_the_excerpt_max_charlength( $textlimit ); ?>
				                    <p class="wrap-btn-style"><a class="btn btn-style" href="<?php echo esc_url($permalink); ?>"><?php _e( 'Read More','corpea' ); ?></a></p>
...
Plugin::instance()->widgets_manager->register_widget_type( new Themesmoon_Widget_Posts_Grid() );