...
class Widget_Themeum_Button extends Widget_Base {
	...
	public function get_name() {
		return 'thmoon-button';
	}

	public function get_title() {
		return __( 'Themesmoon Button', 'coprea' );
	}
	...
	public static function get_button_sizes() {
		return [
			'xs' => __( 'Extra Small', 'coprea' ),
			'sm' => __( 'Small', 'coprea' ),
			'md' => __( 'Medium', 'coprea' ),
			'lg' => __( 'Large', 'coprea' ),
			'xl' => __( 'Extra Large', 'coprea' ),
		];
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'button_type',
			[
				'label' 		=> __( 'Type', 'coprea' ),
				'type' 			=> Controls_Manager::SELECT,
				'default' 		=> '',
				'options' 		=> [
					'' 			=> __( 'Default', 'coprea' ),
					'info' 		=> __( 'Info', 'coprea' ),
					'success' 	=> __( 'Success', 'coprea' ),
					'warning' 	=> __( 'Warning', 'coprea' ),
					'danger' 	=> __( 'Danger', 'coprea' ),
				],
		...
		$this->add_control(
			'text',
			[
				'label' 		=> __( 'Text', 'coprea' ),
				'type' 			=> Controls_Manager::TEXT,
				'default' 		=> __( 'Click me', 'coprea' ),
				'placeholder' 	=> __( 'Click me', 'coprea' ),
				'dynamic' 		=> [],
			]
		);
		...
		$this->add_control(
			'icon_align',
			[
				'label' 	=> __( 'Icon Position', 'coprea' ),
				'type' 		=> Controls_Manager::SELECT,
				'default' 	=> 'left',
				'options' 	=> [
					'left' 	=> __( 'Before', 'coprea' ),
					'right' => __( 'After', 'coprea' ),
				],
				'condition' => [ 'icon!' => '' ],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' 		=> 'solid',
				'options' 		=> [
					'solid' 	=> __( 'Solid Color', 'coprea' ),
					'gradient' 	=> __( 'Gradient Color', 'coprea' ),
				],
			]
		);
