...
class Themeum_Widget_Counter extends Widget_Base {
    public function get_name() {
        return 'thmoon-counter';
    }

    public function get_title() {
        return __( 'Themesmoom Counter', 'coprea' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            'counter_digit',
            [
                'label'         => __( 'Digit Number', 'coprea' ),
                'type'          => Controls_Manager::NUMBER,
                'label_block'   => true,
                'default'       => __( '60', 'coprea' ),
            ]
        );
        $this->add_control(
            'currency_symbol',
            [
                'label'         => __( 'Prefix Text', 'coprea' ),
        ...
        $this->add_responsive_control(
            'section_padding',
            [
                'label' => __( 'Section Padding', 'coprea' ),
        ...
        $this->add_responsive_control(
            'text_padding',
            [
                'label' => __( 'Counter Padding', 'coprea' ),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', 'em', '%' ],
                'selectors' => [
        ...
        $this->add_responsive_control(
            'text_margin',
            [
                'label' => __( 'Counter Margin', 'coprea' ),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', 'em', '%' ],
                'selectors' => [
