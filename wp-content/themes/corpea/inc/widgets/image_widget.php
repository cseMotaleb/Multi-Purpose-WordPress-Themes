...
add_action('widgets_init','register_themesmoon_image_widget');

function register_themesmoon_image_widget()
{
	register_widget('Themesmoon_Image_Widget');
}

class Themesmoon_Image_Widget extends WP_Widget{

	public function __construct()
	{
		parent::__construct( 'Themesmoon_Image_Widget','themeum Image Ads',array('description' => 'This Image Ads Widgets'));
	}
	...
	public function form( $instance )
	{
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'ads_img_link1' )); ?>"><?php esc_html_e( 'Ads Link', 'newedge' ); ?></label>
			...
			<label for="<?php echo esc_attr($this->get_field_id( 'ads_img1' )); ?>"><?php esc_html_e( 'Ads Image URL', 'newedge' ); ?></label>
			...
			<input type="hidden" id="<?php echo esc_attr($this->get_field_id('ads_img1'));?>" name="<?php echo esc_attr($this->get_field_name('ads_img1'));?>" class="<?php echo esc_attr($this->get_field_id('ads_img1'));?>" value="<?php echo esc_attr($instance['ads_img1']); ?>"/>
 			<button id="<?php echo esc_attr($this->get_field_id('ads_img1'));?>" class="custom-upload button" data-url="<?php echo esc_url(get_site_url()); ?>"><?php echo esc_html__('Upload image','newedge'); ?></button>
